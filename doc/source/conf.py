# -*- coding: utf-8 -*-
#
# Cat Utils documentation build configuration file, created by
# sphinx-quickstart on Fri Dec 18 10:09:26 2015.
#
...
from lsst.sims.catUtils import __version__
version = __version__
...
latex_documents = [
  (master_doc, 'CatUtils.tex', u'Cat Utils Documentation',
...
man_pages = [
    (master_doc, 'catutils', u'Cat Utils Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'CatUtils', u'Cat Utils Documentation',
   author, 'CatUtils', 'One line description of project.',
   'Miscellaneous'),
]
