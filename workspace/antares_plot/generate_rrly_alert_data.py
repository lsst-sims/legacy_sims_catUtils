...
from EclipsingBinaryModule import AlertDataGenerator
...
class RRLyAlertObj(StellarAlertDBObjMixin, RRLyStarObj):
    pass
...
def query_htmid(alert_gen, htmid_list, out_dir, out_prefix,
    ...
    try:
        db = RRLyAlertObj(database='LSSTCATSIM',
                          host='fatboy.phys.washington.edu',
                          port=1433, driver='mssql+pymssql',
                          cache_connection=False)
    except RuntimeError:
        db = RRLyAlertObj(cache_connection=False)
